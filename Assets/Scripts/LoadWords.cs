...
public class LoadWords : MonoBehaviour
{
    ...
    private List<string> palabrasList = new List<string>();
    ...
    public string GetRandomWord()
    {
        ...
        return palabrasList[Random.Range(0, palabrasList.Count)];
    }
